        ...
        <div className="flex min-h-screen items-center justify-center p-4 bg-background">
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-card p-10 shadow-2xl ring-1 ring-border/50">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Sign up to get started with Planova</p>
                </div>
                ...
                <p className="text-center text-sm text-muted-foreground">
                    ...
                    <Link href="/login" className="font-medium text-violet-500 hover:text-violet-400 hover:underline transition-colors">
                        Sign in
                    </Link>
                </p>
            </div>
