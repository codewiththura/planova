...
export function EditPlanDialog({ open, onOpenChange, plan, onEditPlan }: EditPlanDialogProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!title.trim() || !startDate || !endDate || !plan) {
            if (!title.trim()) {
                setIsError(true);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
          ...
          `}
                ...
                <DialogHeader className="space-y-1.5 pb-2">
                    <DialogTitle className="text-[20px] font-semibold tracking-tight">Edit Plan</DialogTitle>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-4 py-4 mb-4">
                        <div className="grid gap-2">
                            <label className="text-[13px] font-medium text-foreground/90 ml-0.5" htmlFor="edit-title">
                        ...
                        <div className="grid gap-2">
                            <label className="text-[13px] font-medium text-foreground/90 ml-0.5" htmlFor="edit-description">
                                Description
                            </label>
                            <Textarea
                                id="edit-description"
